const WORKFLOW_BY_SERVICE: Record<string, string[]> = {
  ...
  "조직문화 컨설팅": [
    "조직문화 진단(설문·인터뷰·데이터) 및 핵심 이슈 도출",
    "리더십·커뮤니케이션·협업 관점 원인 구조화",
    "우선과제 선정 및 90일 실행 로드맵 설계",
    "관리자/구성원 실행 프로그램 운영 및 현장 코칭",
    "성과지표 점검(이직·몰입·갈등지표) 및 고도화",
  ],
  "직장 내 괴롭힘 전문 조사": [
    "신고 접수·초기 분류 및 피해자 보호조치 실행",
    "증거·진술 수집과 조사 범위·쟁점 확정",
    "조사위원회 운영 및 사실인정 기준 적용",
    "조치안·재발방지안 권고 및 보고서 제출",
  ],
  "직장 내 성희롱 전문 조사": [
    "신고 접수·비밀유지·피해자 보호조치 실행",
    "증거·진술 확보와 조사 계획 수립",
    "사실인정·판단 기준 검토 및 조사위원회 운영",
    "조치안 권고·2차 피해 방지대책 보고",
  ],
  "징계 사안 전문 조사": [
    "징계 사안 접수 및 사실관계·규정 위반 여부 정리",
    "관련자 소명·증빙 수집과 조사 포인트 확정",
    "징계위원회 상정 전 조사보고서 작성",
    "양정 기준·절차 적법성 점검 및 조치안 제시",
  ],
  "직장 내 괴롭힘": [
    "사건 접수·타임라인 정리 및 긴급 보호조치 실행",
    "증거·진술 확보 및 조사 범위/쟁점 확정",
    "조사위원회 운영, 사실인정·판단 기준 적용",
    "조치안 확정(피해자 보호·행위자 조치·조직조치)",
    "재발방지 체계 구축(규정·교육·모니터링)",
  ],
  "직장 내 성희롱": [
    "사건 접수 및 피해자 보호·비밀유지 조치",
    "증거·진술 수집 및 조사 계획 수립",
    "사실인정·법적 기준 검토 및 조치안 설계",
    "사내 징계·근무조치·2차 피해 방지 실행",
    "예방교육·제도 개선 및 재발방지 점검",
  ],
  "동기부여 컨설팅": [
    "현행 보상·평가·업무설계 진단 및 몰입 저해요인 파악",
    "직군별 동기요인 분석(금전·성장·인정·자율성)",
    "동기부여 제도 설계(목표·평가·보상·피드백)",
    "관리자 실행 툴킷 적용 및 파일럿 운영",
    "성과/몰입 지표 측정 후 제도 보완·정착",
  ],
  "직장 내 괴롭힘 예방체계 구축": [
    "예방규정·판단기준 정비",
    "신고·조사·조치 프로토콜 구축",
...
export function buildWorkflowSteps(serviceName: string): string[] {
  const canonicalName = LEGACY_SERVICE_NAME_MAP[serviceName] || serviceName;
  const mapped = WORKFLOW_BY_SERVICE[canonicalName];
  if (mapped && mapped.length > 0) return mapped;
  return [
    `${canonicalName} 관련 사실관계 진단`,
    "핵심 증빙자료 정리",
    "대응 절차 수립 및 실행",
    "결과 안내 및 후속 조치",
  ];
